 ...
 */
export const assignPurposeIfNeeded = (companions, currentScene) => {
    return companions.map(char => {
      ...
      return {
        ...
        purposeAssignedScene: char.purposeAssignedScene ?? currentScene,
   ...
   */
  export const updatePhaseOutCountdowns = (companions, currentScene) => {
    return companions.map(char => {
   ...
   */
  export const injectPhaseOutLogicIntoPrompt = (companions, currentScene) => {
